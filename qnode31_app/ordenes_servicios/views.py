...
def admin_order_pdf(request, order_id):
    ...
    weasyprint.HTML(string=html,  base_url=request.build_absolute_uri() ).write_pdf(response,stylesheets=[weasyprint.CSS(settings.STATIC_ROOT ,'static/css/pdf.css')], presentational_hints=True)
    return response
